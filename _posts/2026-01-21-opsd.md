...
**Implementation:** The complete paper includes implementation specifications. All experiments employ the Qwen3 model family with LoRA fine-tuning on 8×A100 GPUs.
