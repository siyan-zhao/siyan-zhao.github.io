...
<div class="caption">
    Figure 5: Token efficiency comparison. GRPO stagnates due to reward diversity collapse—over half its batches yield zero reward 
standard deviation within 100 steps, providing less gradient signal on the reasoning dataset.
