...
<p style="text-align:center; margin-top:-1em; margin-bottom:1.5em; font-size:0.9em; color:#888;">
  <em>Note: The previously released code on repo contains some bugs. We are fixing them before re-releasing — sorry for the inconvenience!</em>
</p>
...
OPSD achieves comparable or superior performance while using **8-12× fewer tokens** than GRPO:
...
<div class="caption">
    Figure 5: Token efficiency comparison. With equal generations per update but shorter sequences (1k vs 16k tokens), OPSD achieves comparable or better performance while being 8-12× more token-efficient than GRPO.
</div>
