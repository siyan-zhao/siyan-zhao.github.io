...
In the following figure we compare GRPO and OPSD performance within 100 steps, GRPO stagnates due to reward diversity collapse, more than half of its batches have zero reward standard deviation, yielding no gradient signal even while continuing to sample expensive rollouts.
